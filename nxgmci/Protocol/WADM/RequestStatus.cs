...
namespace nxgmci.Protocol.WADM
{
    public class RequestStatus
    {
        ...
        internal RequestStatus(StatusCode Status, string RawStatus)
        {
            this.Status = Status;
        ...
        internal RequestStatus(StatusCode Status, string RawStatus, ErrorReason Reason, string RawReason)
        {
            this.Status = Status;
            this.RawStatus = RawStatus;
            this.Reason = Reason;
        ...
        public static Result<RequestStatus> Parse(Dictionary<string, string> NodeElements, bool FailOnUnknown)
        {
            // Allocate the result object
            Result<RequestStatus> result = new Result<RequestStatus>();
            ...
            {
                case "success":
                    return result.Succeed(new RequestStatus(StatusCode.Success, status));
                case "fail":
                    return result.Succeed(new RequestStatus(StatusCode.Failure, status, ParseReason(reason), reason));
            }
            ...
            return result.Succeed(new RequestStatus(StatusCode.Unknown, status), "The status code is unknown, but the syntax is valid!");
        }
